...
/// <summary>
/// Payment provider abstraction. Implementations MUST tokenise — NoviMart NEVER receives PAN or CVV.
...
/// <summary>Tokenised payment instrument data — the only payment fields NoviMart is permitted to store.</summary>
