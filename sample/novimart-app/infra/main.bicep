// ============================================================================
// main.bicep — Subscription-scope orchestrator for NoviMart retail commerce.
...
param tags object = {
  ...
  owner: 'platform-engineering@novimart.example'
  'data-classification': 'internal'
  'compliance-scope': 'gdpr,zero-trust'
}

var rgName = 'rg-novimart-${environmentName}-${location}'
