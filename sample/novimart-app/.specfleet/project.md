---
name: "NoviMart E-Commerce"
mode: "greenfield"
description: "B2C retail commerce platform for NoviMart — product catalog, cart, checkout (with tokenising redirect to a PCI provider), customer accounts, order history. Backend is API-as-BFF for the React SPA."
...
A modern, accessible, GDPR-compliant retail commerce experience for NoviMart
...
- **Admin** — NoviMart employee, signs in via Entra ID with MFA to manage catalog, view orders
