# GDPR Policy — Acme Retail E-Commerce
...
> specific. Owners: `dpo@acme-retail.example`.
...
- DPO (`dpo@acme-retail.example`) is the named breach contact
...
Acme Retail is not directed at children under 16. Account creation requires
