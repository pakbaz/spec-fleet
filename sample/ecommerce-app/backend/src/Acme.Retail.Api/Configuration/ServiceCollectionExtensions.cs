...
using Acme.Retail.Infrastructure.Cosmos;
using Acme.Retail.Infrastructure.Cosmos.Repositories;
using Acme.Retail.Infrastructure.Payments;
using Azure.Monitor.OpenTelemetry.AspNetCore;
using Microsoft.Azure.Cosmos;
using OpenTelemetry.Trace;

namespace Acme.Retail.Api.Configuration;
...
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddAcmeInfrastructure(
    ...
    /// </summary>
    public static IServiceCollection AddAcmeTelemetry(
        this IServiceCollection services, IConfiguration configuration)
    {
        ArgumentNullException.ThrowIfNull(services);
        ArgumentNullException.ThrowIfNull(configuration);
