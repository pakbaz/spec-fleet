...
1. `.eas/instruction.md` → `policies.compliance` (corporate baseline)
2. `.eas/project.md` → `complianceScope` (must include `gdpr` for this charter to apply)
3. `.eas/policies/gdpr.md` (concrete project policy file, if present)
